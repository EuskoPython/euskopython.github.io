...
BLOG_AUTHOR = "Basque Python Society"  # (translatable)
BLOG_TITLE = "EuskoPython"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://euskopython.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://euskopython.github.io/"
BLOG_EMAIL = "euskopython.github.io"
BLOG_DESCRIPTION = "This is the site of the Basque Python Society"  # (translatable)
